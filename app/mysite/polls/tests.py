...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_qeustion(self):
        """
        was_published_recently() returns False whose pub_date
        is older than 1 day.
        """
    ...
    def test_was_published_recently_with_recent_qeustion(self):
        """
        was_published_recently() returns True whose pub_date
...
class QuestionIndexViewTests(TestCase):
    def test_no_questions(self):
        """
        If no questions exit, an appropriate message in displayed.
        """
